...
for(let index=0;index<FilmData.length;index++){
    let SingleDataObject=FilmData[index]
    console.log(`Title is ${SingleDataObject.Title}`)
    FilmString = FilmString+`
    <div> <b>Title:</b> ${SingleDataObject.Title}</div>
    <div <b>Year:</b> ${SingleDataObject.Year}</div>
    <div <b>Rated:</b> ${SingleDataObject.Rated}</div>
    <div <b>Released:</b> ${SingleDataObject.Released}</div>
    <div <b> Runtime:</b> ${SingleDataObject. Runtime}</div>
    <div <b>Genre:</b> ${SingleDataObject.Genre}</div>
    <div <b>Director:</b> ${SingleDataObject.Director}</div>
